...
public class ClientScreenGetFocusedEvent implements ReturnableEvent<InputListener> {
    ...
    public ClientScreenGetFocusedEvent(MinecraftClient client, Screen screen, InputListener value) {
        this.client = client;
        this.screen = screen;
        this.value = value;
    }
